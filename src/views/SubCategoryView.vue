      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-6 col-12">
          <div class="breadcrumbs-content">
            <h1 class="page-title">Ecom Mart</h1>
          </div>
        </div>
        <div class="col-lg-6 col-md-6 col-12">
                  ...
                  <div class="col-lg-4 col-md-6 col-12" v-for="(product, key) in products" :key="key">
                    <div class="single-product">
                      ...
                      <div class="product-info">
                        ...
                        <span class="category">{{product.category_id.category_name}}</span> 
                        <h4 class="title">
...
<script>
  import axios from 'axios'
    export default{
        ...
        created(){
          axios.get('http://127.0.0.1:8000/api/get-sub-category-product/' + this.id).then(response=>{
